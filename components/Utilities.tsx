        ...
        return (
            <div className="fixed inset-0 z-[100] bg-black flex flex-col justify-center p-8 animate-fade-in" onClick={() => setShowCard(false)}>
                <div className="text-center space-y-8">
                    <div>
                        <p className="text-xs text-neutral-500 uppercase tracking-widest mb-2">Hotel</p>
                        <h1 className="text-4xl font-bold text-white leading-tight">{formData.name}</h1>
                    </div>
                    <div>
                        <p className="text-xs text-neutral-500 uppercase tracking-widest mb-2">Address</p>
                        <p className="text-2xl text-white leading-relaxed">{formData.address}</p>
                    </div>
                    {formData.bookingRef && (
                        <div className="pt-8 border-t border-neutral-800">
                            <p className="text-xs text-neutral-500 uppercase tracking-widest mb-2">Booking Ref</p>
                            <p className="text-3xl font-mono text-amber-400 tracking-widest">{formData.bookingRef}</p>
                        </div>
                    )}
